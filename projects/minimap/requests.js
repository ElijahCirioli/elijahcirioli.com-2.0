function updateMarkerInDatabase(markerData, markerObj) {
	...
	fetch("https://osuminimap.onrender.com/editMarker", {
		method: "POST",
...
function postMarkerToDatabase(markerData, markerObj) {
	...
	fetch("https://osuminimap.onrender.com/postMarker", {
		method: "POST",
		body: JSON.stringify(postData),
		headers: {
			"Content-Type": "application/json",
...
function reportMarker(markerObj) {
	...
	fetch("https://osuminimap.onrender.com/reportMarker", {
		method: "POST",
...
function postReviewToDatabase(markerData, markerObj, review) {
	fetch("https://osuminimap.onrender.com/postReview", {
		method: "POST",
...
function reportReview(markerObj, review) {
	...
	fetch("https://osuminimap.onrender.com/reportReview", {
		method: "POST",
		body: JSON.stringify(report),
		headers: {
			"Content-Type": "application/json",
