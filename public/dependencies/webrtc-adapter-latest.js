			...
			6: [
				function (require, module, exports) {
					...
					function shimSenderGetStats(window) {
						if (
							!(_typeof(window) === "object" && window.RTCPeerConnection && window.RTCRtpSender)
						) {
							return;
						}
			...
			11: [
				function (require, module, exports) {
					...
					SDPUtils.parseRtpParameters = function (mediaSection) {
						...
						var wildcardRtcpFb = SDPUtils.matchPrefix(mediaSection, "a=rtcp-fb:* ").map(
					...
					SDPUtils.parseRtpEncodingParameters = function (mediaSection) {
						...
						var flows = SDPUtils.matchPrefix(mediaSection, "a=ssrc-group:FID").map(function (
							line
						) {
						...
						if (bandwidth.length) {
							if (bandwidth[0].indexOf("b=TIAS:") === 0) {
								...
								bandwidth =
									parseInt(bandwidth[0].substring(5), 10) * 1000 * 0.95 - 50 * 40 * 8;
							} else {
								bandwidth = undefined;
							}
					...
					SDPUtils.writeRtcpParameters = function (rtcpParameters) {
						...
						if (rtcpParameters.ssrc !== undefined && rtcpParameters.cname) {
							sdp +=
								"a=ssrc:" + rtcpParameters.ssrc + " cname:" + rtcpParameters.cname + "\r\n";
						}
						return sdp;
					};
