// setup the websocket
const socket = io("https://zingvideochat.onrender.com", {
	cors: {
...
let inactivityTimer; // timer for Render inactivity timeout

// start a new call
function createRoom() {
	initiatior = true;
	// get a unique room ID
	$.get("https://zingvideochat.onrender.com/roomId", (res) => {
		room = res;
