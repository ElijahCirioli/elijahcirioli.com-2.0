...
function loadDictionary() {
	...
	$.get("https://osuminimap.onrender.com/dictionary.json", (data) => {
...
$("#review-creation-button").click((e) => {
	...
	$.get(`https://osuminimap.onrender.com/username/${userId}`).then((res) => {
...
$(document).ready(() => {
	...
	if (userId) {
		...
		$.get("https://osuminimap.onrender.com/generateUser")
			.then((res) => {
